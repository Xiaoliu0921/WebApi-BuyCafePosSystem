...
{
    /// <summary>
    /// JwtAuthFilter_E 繼承 ActionFilterAttribute 可生成 [JwtAuthFilter] 使用
    /// </summary>
    public class JwtAuthFilter_E : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            if (request.Headers.Authorization == null || request.Headers.Authorization.Scheme != "Bearer")
            {
                ...
                string messageJson = JsonConvert.SerializeObject(new { statusCode = 401,code=-1, message = "請重新登入" }); // JwtToken 遺失，需導引重新登入
