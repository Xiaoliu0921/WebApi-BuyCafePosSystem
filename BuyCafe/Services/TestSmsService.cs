...
namespace BuyCafe.Services
{
    public class TestSmsService
    {
        ...
        // 檢查手機格式
        public bool CheckPhoneFormat2(string customerPhone)
        {
        ...
        /*
           ...
           3. 透過Twilio發送驗證碼
       */
        public async Task GenerateCodeAndSendAsync2(string customerPhone)
        {
        ...
        // 驗證顧客身份
        public VerificationResult VerifyCustomer2(string customerPhone, string verifyCode)
        {
